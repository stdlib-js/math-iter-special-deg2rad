...
```javascript
iterDeg2rad = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-deg2rad@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-deg2rad@umd/bundle.js"></script>
```
