...
```javascript
import iterDeg2rad from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-deg2rad@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-deg2rad/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/math-iter-special-deg2rad/actions/workflows/test.yml?query=branch:v0.1.0
